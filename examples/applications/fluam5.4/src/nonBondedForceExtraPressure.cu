// Filename: nonBondedForceExtraPressure.cu
//
...
__device__ double functionDeltaDerived(double r){
  if(fabs(r)>=1.5){
    return 0;
  }
  else if(fabs(r)<=0.5){
    return ( r / sqrt(1. - 3.*r*r));
  }
  else{
    //return ( ((r<0)-(r>0)) * (0.5 + 0.5 * (1-fabs(r)) / sqrt(1. - 3.*(1.-fabs(r))*(1.-fabs(r))) )  );
    return ( ((r>0)-(r<0)) * 0.5 * (1. + (1.-fabs(r)) / sqrt(-2.+6.*fabs(r)-3.*r*r)) );
  }
...
__global__ void nonBondedForceExtraPressure(double* rxcellGPU, double* rycellGPU, double* rzcellGPU,
					    double* vxboundaryGPU, double* vyboundaryGPU, double* vzboundaryGPU,
					    double* densityGPU,
					    double* fxboundaryGPU, double* fyboundaryGPU, double* fzboundaryGPU,
					    particlesincell* pc, int* errorKernel,
					    double* saveForceX, double* saveForceY, double* saveForceZ){
  ...
  //dlS  = ((r<0)-(r>0))   * tex1D(texDeltaDerived, fabs(r));
  //dlpS = ((rp<0)-(rp>0)) * tex1D(texDeltaDerived, fabs(rp));
  //dlmS = ((rm<0)-(rm>0)) * tex1D(texDeltaDerived, fabs(rm)); 
  ...
  /*spxpypz = invdxGPU * dlpS * dlyp * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpypz] + densityGPU[vecinopxpxpypz]));

  spxpy = invdxGPU * dlpS * dlyp * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpy] + densityGPU[vecinopxpxpy]));

  spxpymz = invdxGPU * dlpS * dlyp * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpymz] + densityGPU[vecinopxpxpymz]));

  spxpz = invdxGPU * dlpS * dly * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpz] + densityGPU[vecinopxpxpz]));

  spx = invdxGPU * dlpS * dly * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino3] + densityGPU[vecinopxpx]));

  spxmz = invdxGPU * dlpS * dly * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmz] + densityGPU[vecinopxpxmz]));

  spxmypz = invdxGPU * dlpS * dlym * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmypz] + densityGPU[vecinopxpxmypz]));

  spxmy = invdxGPU * dlpS * dlym * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmy] + densityGPU[vecinopxpxmy]));

  spxmymz = invdxGPU * dlpS * dlym * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmymz] + densityGPU[vecinopxpxmymz]));

  spypz = invdxGPU * dlS * dlyp * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopypz] + densityGPU[vecinopxpypz]));

  spy = invdxGPU * dlS * dlyp * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino4] + densityGPU[vecinopxpy]));

  spymz = invdxGPU * dlS * dlyp * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopymz] + densityGPU[vecinopxpymz]));

  spz = invdxGPU * dlS * dly * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino5] + densityGPU[vecinopxpz]));

  s = invdxGPU * dlS * dly * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[icelx] + densityGPU[vecino3]));

  smz = invdxGPU * dlS * dly * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino0] + densityGPU[vecinopxmz]));

  smypz = invdxGPU * dlS * dlym * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomypz] + densityGPU[vecinopxmypz]));

  smy = invdxGPU * dlS * dlym * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino1] + densityGPU[vecinopxmy]));

  smymz = invdxGPU * dlS * dlym * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomymz] + densityGPU[vecinopxmymz]));

  smxpypz = invdxGPU * dlmS * dlyp * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpypz] + densityGPU[vecinopypz]));

  smxpy = invdxGPU * dlmS * dlyp * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpy] + densityGPU[vecino4]));

  smxpymz = invdxGPU * dlmS * dlyp * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpymz] + densityGPU[vecinopymz]));

  smxpz = invdxGPU * dlmS * dly * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpz] + densityGPU[vecino5]));

  smx = invdxGPU * dlmS * dly * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino2] + densityGPU[icelx]));

  smxmz = invdxGPU * dlmS * dly * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmz] + densityGPU[vecino0]));

  smxmypz = invdxGPU * dlmS * dlym * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmypz] + densityGPU[vecinomypz]));

  smxmy = invdxGPU * dlmS * dlym * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmy] + densityGPU[vecino1]));

  smxmymz = invdxGPU * dlmS * dlym * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmymz] + densityGPU[vecinomymz]));*/
  ...
  //f = 0.f;
  //printf("TTTTTTTTTTTT %f %f %f %f \n",v,u,volumeParticleGPU,f);
  ...
  /*spxpypz = invdyGPU * dlxp * dlpS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpypz] + densityGPU[vecinopypxpypz]));

  spxpy = invdyGPU * dlxp * dlpS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpy] + densityGPU[vecinopypxpy]));

  spxpymz = invdyGPU * dlxp * dlpS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpymz] + densityGPU[vecinopypxpymz]));

  spxpz = invdyGPU * dlxp * dlS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpz] + densityGPU[vecinopxpypz]));

  spx = invdyGPU * dlxp * dlS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino3] + densityGPU[vecinopxpy]));

  spxmz = invdyGPU * dlxp * dlS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmz] + densityGPU[vecinopxpymz]));

  spxmypz = invdyGPU * dlxp * dlmS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmypz] + densityGPU[vecinopxpz]));

  spxmy = invdyGPU * dlxp * dlmS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmy] + densityGPU[vecino3]));

  spxmymz = invdyGPU * dlxp * dlmS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmymz] + densityGPU[vecinopxmz]));

  spypz = invdyGPU * dlx * dlpS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopypz] + densityGPU[vecinopypypz]));

  spy = invdyGPU * dlx * dlpS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino4] + densityGPU[vecinopypy]));

  spymz = invdyGPU * dlx * dlpS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopymz] + densityGPU[vecinopypymz]));

  spz = invdyGPU * dlx * dlS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino5] + densityGPU[vecinopypz]));

  s = invdyGPU * dlx * dlS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[icely] + densityGPU[vecino4]));

  smz = invdyGPU * dlx * dlS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino0] + densityGPU[vecinopymz]));

  smypz = invdyGPU * dlx * dlmS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomypz] + densityGPU[vecino5]));

  smy = invdyGPU * dlx * dlmS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino1] + densityGPU[icely]));

  smymz = invdyGPU * dlx * dlmS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomymz] + densityGPU[vecino0]));

  smxpypz = invdyGPU * dlxm * dlpS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpypz] + densityGPU[vecinopymxpypz]));

  smxpy = invdyGPU * dlxm * dlpS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpy] + densityGPU[vecinopymxpy]));

  smxpymz = invdyGPU * dlxm * dlpS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpymz] + densityGPU[vecinopymxpymz]));

  smxpz = invdyGPU * dlxm * dlS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpz] + densityGPU[vecinomxpypz]));

  smx = invdyGPU * dlxm * dlS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino2] + densityGPU[vecinomxpy]));

  smxmz = invdyGPU * dlxm * dlS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmz] + densityGPU[vecinomxpymz]));

  smxmypz = invdyGPU * dlxm * dlmS * dlzp * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmypz] + densityGPU[vecinomxpz]));

  smxmy = invdyGPU * dlxm * dlmS * dlz * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmy] + densityGPU[vecino2]));

  smxmymz = invdyGPU * dlxm * dlmS * dlzm * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmymz] + densityGPU[vecinomxmz]));*/
  ...
  /*spxpypz = invdzGPU * dlxp * dlyp * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpypz] + densityGPU[vecinopzpxpypz]));

  spxpy = invdzGPU * dlxp * dlyp * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpy] + densityGPU[vecinopxpypz]));

  spxpymz = invdzGPU * dlxp * dlyp * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpymz] + densityGPU[vecinopxpy]));

  spxpz = invdzGPU * dlxp * dly * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxpz] + densityGPU[vecinopzpxpz]));

  spx = invdzGPU * dlxp * dly * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino3] + densityGPU[vecinopxpz]));

  spxmz = invdzGPU * dlxp * dly * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmz] + densityGPU[vecino3]));

  spxmypz = invdzGPU * dlxp * dlym * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmypz] + densityGPU[vecinopzpxmypz]));

  spxmy = invdzGPU * dlxp * dlym * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmy] + densityGPU[vecinopxmypz]));

  spxmymz = invdzGPU * dlxp * dlym * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopxmymz] + densityGPU[vecinopxmy]));

  spypz = invdzGPU * dlx * dlyp * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopypz] + densityGPU[vecinopzpypz]));

  spy = invdzGPU * dlx * dlyp * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino4] + densityGPU[vecinopypz]));

  spymz = invdzGPU * dlx * dlyp * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinopymz] + densityGPU[vecino4]));

  spz = invdzGPU * dlx * dly * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino5] + densityGPU[vecinopzpz]));

  s = invdzGPU * dlx * dly * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[icelz] + densityGPU[vecino5]));

  smz = invdzGPU * dlx * dly * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino0] + densityGPU[icelz]));

  smypz = invdzGPU * dlx * dlym * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomypz] + densityGPU[vecinopzmypz]));

  smy = invdzGPU * dlx * dlym * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino1] + densityGPU[vecinomypz]));

  smymz = invdzGPU * dlx * dlym * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomymz] + densityGPU[vecino1]));

  smxpypz = invdzGPU * dlxm * dlyp * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpypz] + densityGPU[vecinopzmxpypz]));

  smxpy = invdzGPU * dlxm * dlyp * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpy] + densityGPU[vecinomxpypz]));

  smxpymz = invdzGPU * dlxm * dlyp * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpymz] + densityGPU[vecinomxpy]));

  smxpz = invdzGPU * dlxm * dly * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxpz] + densityGPU[vecinopzmxpz]));

  smx = invdzGPU * dlxm * dly * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecino2] + densityGPU[vecinomxpz]));

  smxmz = invdzGPU * dlxm * dly * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmz] + densityGPU[vecino2]));

  smxmypz = invdzGPU * dlxm * dlym * dlpS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmypz] + densityGPU[vecinopzmxmypz]));

  smxmy = invdzGPU * dlxm * dlym * dlS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmy] + densityGPU[vecinomxmypz]));

  smxmymz = invdzGPU * dlxm * dlym * dlmS * temperatureGPU * dtGPU *
    (massParticleGPU/(densfluidGPU*volumeGPU*volumeParticleGPU) + 1) * 2 /
    (volumeGPU * (densityGPU[vecinomxmymz] + densityGPU[vecinomxmy]));*/
