...
bool firstStepQuasiNeutrallyBuoyant2D(int numBlocksNeighbors,
  ...
  //and save advection
  kernelConstructWQuasiNeutrallyBuoyant_2D<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
									  vyPredictionGPU,
									  vzPredictionGPU,
									  vxZ,//W
									  vyZ,//W
  ...
  if(mass != 0 ){
    ...
    kernelCalculateDeltapFirstStep_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										       rycellGPU,
										       rzcellGPU,
										       vxboundaryGPU,
										       vyboundaryGPU,
  ...
  findNeighborParticlesQuasiNeutrallyBuoyantTEST4_3_2D<<<numBlocksParticles,threadsPerBlockParticles>>>
    (pc, 
     errorKernel,
     rxcellGPU,
     rycellGPU,
  ...
  if(mass != 0){
    ...
    interpolateLaplacianDeltaV_2_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										     rycellGPU,
										     rzcellGPU,
										     vxZ,
										     vyZ,
  ...
  /*kernelConstructWQuasiNeutrallyBuoyantTEST5_3<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
									      ...
									      advYGPU,
									      advZGPU);*/
  kernelConstructWQuasiNeutrallyBuoyantTEST5_2_2D<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
										 vyPredictionGPU,
										 vzPredictionGPU,
										 vxZ,//W
										 vyZ,//W
