// Filename: kernelFeedGhostCellsGiantFluctuations.cu
//
...
__global__ void kernelFeedGhostCellsGiantFluctuations(int* ghostToPIGPU, 
						      int* ghostToGhostGPU,
						      double* densityGPU, 
...
__global__ void kernelFeedGhostCellsGiantFluctuations2(int* ghostToPIGPU, 
						       int* ghostToGhostGPU,
						       double* densityGPU, 
						       double* densityPredictionGPU,
						       double* vxGPU, 
    ...
    if(fy==0){
      ...
      cGPU[ighost] = cGPU[ighost+mxtGPU]*
	(2+soretCoefficientGPU*gradTemperatureGPU*dyGPU)/
	(2-soretCoefficientGPU*gradTemperatureGPU*dyGPU);
      
      cPredictionGPU[ighost] = cPredictionGPU[ighost+mxtGPU]*
	(2+soretCoefficientGPU*gradTemperatureGPU*dyGPU)/
	(2-soretCoefficientGPU*gradTemperatureGPU*dyGPU);
      ...
      d_rand[n0+ighost+7*ncellstGPU] = 0;//1.4142135624 * d_rand[n0+ighost+8*ncellstGPU];
      d_rand[n0+ighost+16*ncellstGPU] = 0;//1.4142135624 * d_rand[n0+ighost+17*ncellstGPU];
	...
	(2+soretCoefficientGPU*gradTemperatureGPU*dyGPU);
      ...
      d_rand[n0+(ighost-mxtGPU)+7*ncellstGPU] = 0;//1.4142135624 * d_rand[n0+(ighost)+7*ncellstGPU];
      d_rand[n0+(ighost-mxtGPU)+16*ncellstGPU] = 0;//1.4142135624 * d_rand[n0+(ighost)+16*ncellstGPU];
