...
__global__ void forceBoundary(double* rxboundaryGPU, double* ryboundaryGPU, double* rzboundaryGPU,
			      ...
			      double* rxcellGPU, double* rycellGPU, double* rzcellGPU,
  ...
  force = (v - vxboundaryGPU[i]) * volumeboundaryconstGPU;
  ...
  force = (v - vyboundaryGPU[i]) * volumeboundaryconstGPU;
  ...
  force = (v - vzboundaryGPU[i]) * volumeboundaryconstGPU;
