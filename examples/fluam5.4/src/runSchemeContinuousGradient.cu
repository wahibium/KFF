...
bool runSchemeContinuousGradient(){
  ...
  while(step<numsteps){
    ...
    kernelFeedGhostCellsBinaryMixture<<<numBlocksGhost,threadsPerBlockGhost>>>(ghostToPIGPU,ghostToGhostGPU,
									       ...
									       cGPU,cPredictionGPU,dRand,substep);
    //First substep RK3
    kernelDpContinuousGradient_1<<<numBlocks,threadsPerBlock>>>(densityGPU,densityGPU,
								vxGPU,vyGPU,vzGPU,
								dmGPU,
								...
								substep,0,1,-sqrt(3));
    kernelDpContinuousGradient_2<<<numBlocks,threadsPerBlock>>>(densityPredictionGPU,
								vxPredictionGPU,vyPredictionGPU,vzPredictionGPU,
								dmGPU,
								dpxGPU,dpyGPU,dpzGPU,
    ...
    kernelFeedGhostCellsBinaryMixture<<<numBlocksGhost,threadsPerBlockGhost>>>(ghostToPIGPU,ghostToGhostGPU,
									       ...
									       cGPU,cPredictionGPU,dRand,substep);
    //Second substep RK3
    kernelDpContinuousGradient_1<<<numBlocks,threadsPerBlock>>>(densityPredictionGPU,densityGPU,
								vxGPU,vyGPU,vzGPU,
								dmGPU,
								dpxGPU,dpyGPU,dpzGPU,
								cPredictionGPU,cGPU,dcGPU,
								dRand,
								ghostIndexGPU,realIndexGPU,
								substep,0.75,0.25,sqrt(3));
    kernelDpContinuousGradient_2<<<numBlocks,threadsPerBlock>>>(densityPredictionGPU,
								vxPredictionGPU,vyPredictionGPU,vzPredictionGPU,
								dmGPU,
								dpxGPU,dpyGPU,dpzGPU,
    ...
    kernelDpContinuousGradient_1<<<numBlocks,threadsPerBlock>>>(densityPredictionGPU,densityGPU,
								...
								ghostIndexGPU,realIndexGPU,
								substep,1./3.,2./3.,0);
    kernelDpContinuousGradient_2<<<numBlocks,threadsPerBlock>>>(densityGPU,
								vxGPU,vyGPU,vzGPU,
								dmGPU,
								dpxGPU,dpyGPU,dpzGPU,
								cGPU,dcGPU,
