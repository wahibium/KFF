// Filename: boundaryParticlesFunctionIncompressible.cu
//
...
void boundaryParticlesFunctionIncompressible(int numBlocksBoundary, 
  ...
  if(setboundary){
    forceIncompressibleBoundary<<<numBlocksBoundary,threadsPerBlockBoundary>>>(rxboundaryGPU,
									       ryboundaryGPU,
									       rzboundaryGPU,
									       vxboundaryGPU,
									       vyboundaryGPU,
  ...
  if(setparticles){
    findNeighborParticles<<<numBlocksPartAndBoundary,threadsPerBlockPartAndBoundary>>>(pc,errorKernel,
										       ...
										       vyboundaryGPU,
										       vzboundaryGPU);
    nonBondedForceIncompressible<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										  rycellGPU,
										  rzcellGPU,
										  vxboundaryGPU,
										  vyboundaryGPU,
