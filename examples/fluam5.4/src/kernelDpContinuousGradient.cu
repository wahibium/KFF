// Filename: kernelDpContinuousGradient.cu
//
...
__global__ void kernelDpContinuousGradient_1(double* densityGPU, double* densityGPU2,
					     double* vxGPU, double* vyGPU,double* vzGPU,
					     double* dmGPU,
					     double* dpxGPU, double* dpyGPU, double* dpzGPU,
					     double* cGPU, double* cGPU2, double* dcGPU,
					     double* d_rand,
					     int* ghostIndex, int* realIndex,
					     int substep, double RK1, double RK2, double RK3){
  ...
  //dc += (vy4 + vy) * density * gradTemperatureGPU;
  dc += (vy + vy1) * density * gradTemperatureGPU;
...
__global__ void kernelDpContinuousGradient_2(double* densityGPU,
					     double* vxGPU, double* vyGPU,double* vzGPU,
					     double* dmGPU,
					     double* dpxGPU, double* dpyGPU, double* dpzGPU,
					     double* cGPU, double* dcGPU,
					     int* ghostIndex, int* realIndex){
