...
bool firstStepQuasiNeutrallyBuoyant4pt2D(int numBlocksNeighbors,
  ...
  findNeighborParticlesQuasiNeutrallyBuoyant4pt_1_2D<<<numBlocksParticles,threadsPerBlockParticles>>>
    (pc, 
     errorKernel,
     rxcellGPU,
     rycellGPU,
  ...
  kernelSpreadParticlesForce4pt2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										   rycellGPU,
										   rzcellGPU,
										   fxboundaryGPU,
										   fyboundaryGPU,
  ...
  //and save advection
  kernelConstructWQuasiNeutrallyBuoyant4pt_2D<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
									     vyPredictionGPU,
									     vzPredictionGPU,
									     vxZ,//W
									     vyZ,//W
  ...
  if(mass != 0){
    ...
    kernelCalculateDeltau4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										 rycellGPU,
										 rzcellGPU,
										 vxGPU,
										 vyGPU,
  ...
  if(mass != 0 ){
    ...
    kernelCalculateDeltapFirstStep4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
											  rycellGPU,
											  rzcellGPU,
											  vxboundaryGPU,
											  vyboundaryGPU,
  ...
  if(mass != 0){
    ...
    kernelSpreadDeltap4pt2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
									     rycellGPU,
									     rzcellGPU,
									     vxboundaryPredictionGPU,
									     vyboundaryPredictionGPU,
    ...
    kernelCorrectionVQuasiNeutrallyBuoyant4pt_2_2D<<<numBlocks,threadsPerBlock>>>(vxZ,
										  vyZ,
										  vzZ,
										  fxboundaryGPU,
										  fyboundaryGPU,
  ...
  if(mass != 0){
    ...
    kernelSpreadDeltapMinusJTildev4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
											  rycellGPU,
											  rzcellGPU,
											  vxZ,
											  vyZ,
  ...
  findNeighborParticlesQuasiNeutrallyBuoyant4ptTEST4_3_2D<<<numBlocksParticles,threadsPerBlockParticles>>>
    (pc, 
     errorKernel,
     rxcellGPU,
     rycellGPU,
  ...
  if(mass != 0){
    ...
    interpolateLaplacianDeltaV4pt_2_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
											rycellGPU,
											rzcellGPU,
											vxZ,
											vyZ,
  ...
  calculateAdvectionFluid_2D<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
							    vyPredictionGPU,
							    vzPredictionGPU,
							    vxZ,
							    vyZ,
  ...
  /*kernelConstructWQuasiNeutrallyBuoyantTEST5_3<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
									      ...
									      advYGPU,
									      advZGPU);*/
  kernelConstructWQuasiNeutrallyBuoyant4ptTEST5_2_2D<<<numBlocks,threadsPerBlock>>>(vxPredictionGPU,
										    vyPredictionGPU,
										    vzPredictionGPU,
										    vxZ,//W
										    vyZ,//W
  ...
  if(mass != 0 ){
    ...
    kernelCalculateDeltap4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										 rycellGPU,
										 rzcellGPU,
										 vxboundaryGPU,
										 vyboundaryGPU,
  ...
  //STEP 8: UPDATE PARTICLE VELOCITY
  if(mass == 0){
    updateParticleVelocityme04pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										     rycellGPU,
										     rzcellGPU,
										     vxboundaryGPU,
										     vyboundaryGPU,
    ...
    updateParticleVelocityme4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										    rycellGPU,
										    rzcellGPU,
										    vxZ,
										    vyZ,
  ...
  //Update particle position q^{n+1} = q^n + dt * J^{n+1/2} v^{n+1/2}
  findNeighborParticlesQuasiNeutrallyBuoyant4ptTEST4_2_2D<<<numBlocksParticles,threadsPerBlockParticles>>>
    (pc, 
     errorKernel,
     rxcellGPU,
     rycellGPU,
  ...
  if(mass != 0){
    ...
    //Calculate 0.5*dt*nu*J*L*\Delta v and store it
    //in vxboundaryPredictionGPU
    interpolateLaplacianDeltaV4pt_2D<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										      rycellGPU,
										      rzcellGPU,
										      vxGPU,
										      vyGPU,
