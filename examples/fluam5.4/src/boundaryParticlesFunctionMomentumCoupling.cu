// Filename: boundaryParticlesFunctionFreeEnergyCompressibleParticles.cu
//
...
void boundaryParticlesFunctionMomentumCoupling(int option,
  ...
  if(option==0){
	...
	(pc, 
	 ...
	 vzGPU);
      ...
      kernelSpreadPressureParticles<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										     rycellGPU,
										     rzcellGPU,
										     densityGPU,
										     fboundaryOmega,
      ...
      countToZeroListX<<<numBlocksNeighbors,threadsPerBlockNeighbors>>>(pc);
    ...
    if(setparticles){
      ...
      nonBondedForceMomentumCoupling<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
										      rycellGPU,
										      rzcellGPU,
										      vxboundaryGPU,
										      vyboundaryGPU,
    ...
    updateFluidMomentumCoupling<<<numBlocks,threadsPerBlock>>>(vxGPU,
							       vyGPU,
							       vzGPU,
							       densityGPU,
							       fxboundaryGPU,
    ...
    if(setparticles){
      ...
      calculateVelocityAtHalfTimeStepCompressibleParticles<<<numBlocks,threadsPerBlock>>>
	(vxGPU,//v^{n+1}
	 vyGPU,
	 vzGPU,
