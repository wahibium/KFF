...
namespace cuda {
	...
	*/
	...
	public:
		//! \brief gets the runtime object
		const kff::kffRuntime & kff() const;

	protected:
		//! \brief runtime object containing state related to KFF
		kff::kffRuntime kffRuntime;
	...
	public:
		...
		*/
		...
		virtual kff::PointerMap contextSwitch(unsigned int destinationDevice, 
		...
		/*! \brief Register a callable host function with KFF 
